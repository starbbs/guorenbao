    ...
    bindingExecutors.attr = function(val, elem, data) {
        ...
        if (method === "css") {
            ...
            var scanTemplate = function(text) {
                ...
                scanNodeArray(nodes, vmodels)
                    // // 张树垚 2015-07-01 15:22:30 添加 -- 去除include前后注释
                    // data.startInclude.parentNode.removeChild(data.startInclude)
                    // data.endInclude.parentNode.removeChild(data.endInclude)
            }
