...
var TodoList = React.createClass({displayName: "TodoList",
	...
	render: function() {
		var items = this.state.items.map(function(item) {
			return (
				React.createElement("div", {key: item, onClick: this.handleRemove.bind(this, i)}, item)
			);
		}.bind(this));
		return (
			React.createElement("div", null, 
				React.createElement("botten", {onClick: "this.handleAdd"}, "Add Item"), 
				React.createElement(Transition, {transitionName: "example"}, items)
			)
		);
	}
});
