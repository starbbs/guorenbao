	...
	render: function() {
		...
		return (
			React.createElement("div", null, 
				...
				React.createElement("h4", null, parse)
			)
		);
	}
});
...
React.render(
	React.createElement(HelloWorld, {time: new Date()}), // 必须首字母大写, 否则编译出来带引号
	document.getElementById('hello_world')
);

},{"./hello_world.jsx":1,"react":158}],3:[function(require,module,exports){
